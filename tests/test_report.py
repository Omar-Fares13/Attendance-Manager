from logic.file_write import get_student_data
import os
...
data_rows = get_student_data(1)
course_name = 'دورة 10'

create_excel(headers, data_rows, course_name)
create_pdf(headers, data_rows, course_name)